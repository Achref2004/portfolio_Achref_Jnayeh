...
// Textures de la scène d'entrée
export const TEXTURES_ENTREE = [
    // Core
...
// Images HTML standard (préchargées via new Image() dans App.jsx)
...
export const TEXTURES_UI = [
    '/textures/corridor/avatar_anim/1.png',
    '/textures/corridor/avatar_anim/2.png',
    '/textures/corridor/avatar_anim/3.png',
    '/textures/corridor/avatar_anim/4.png',
    '/textures/corridor/avatar_anim/5.png',
    '/textures/corridor/avatar_anim/6.png',
    '/textures/corridor/avatar_anim/7.png',
    '/textures/corridor/avatar_anim/8.png',
    '/textures/corridor/avatar_anim/9.png',
];
...
export const TEXTURES_GALERIE_BASE = [
...
export const TEXTURES_GALERIE_VERSIONS = [
    // Project cards
    'monetuneprzod',
    'timberkittyprzod',
    'youngmultiprzod',
...
export const TEXTURES_GALERIE = [
    ...TEXTURES_GALERIE_BASE,
    ...TEXTURES_GALERIE_VERSIONS.flatMap(name => [
        `/textures/gallery/${name}.webp`,
        name === 'csslogo' ? `/textures/gallery/css3logo_painted.webp` : `/textures/gallery/${name}_painted.webp`
    ])
];

// Textures de la pièce Contact (chargées via useTexture / drei)
export const TEXTURES_CONTACT = [
...
// Textures de la pièce À propos
export const TEXTURES_A_PROPOS = [
    '/textures/gallery/arr.png',
];

// Textures de la pièce Studio (chargées via useLoader(TextureLoader))
export const TEXTURES_STUDIO = [
    // Monitor (blog)
...
export const PRECHARGEMENT_COMPLET = [
    ...TEXTURES_ENTREE,
    ...TEXTURES_COULOIR,
    ...TEXTURES_UI,
    ...TEXTURES_GALERIE,
...
// Textures chargées via useLoader(TextureLoader) - à propos, studio
export const PRECHARGEMENT_CHARGEUR = [
    ...TEXTURES_A_PROPOS,
    ...TEXTURES_STUDIO,
];
