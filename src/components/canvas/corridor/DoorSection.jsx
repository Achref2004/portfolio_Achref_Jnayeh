...
const DOOR_TEXTURES = {
    'THE GALLERY': '/textures/corridor/doors/beb.png',
    'THE STUDIO': '/textures/corridor/doors/beb.png',
    'THE ABOUT': '/textures/corridor/doors/beb.png',
    "LET'S CONNECT": '/textures/corridor/doors/beb.png',
    'LANGUE': '/textures/corridor/doors/beb.png',
    'LANGUES': '/textures/corridor/doors/beb.png',
    'MES PROJETS': '/textures/corridor/doors/beb.png',
    'A PROPOS': '/textures/corridor/doors/beb.png',
    'À PROPOS': '/textures/corridor/doors/beb.png',
    'ENGAGEMENT ASSOCIATIF': '/textures/corridor/doors/beb.png',
    'ENGAGEMENTS ASSOCIATIFS': '/textures/corridor/doors/beb.png',
    'CERTIFICATION': '/textures/corridor/doors/beb.png',
    'CERTIFICATIONS': '/textures/corridor/doors/beb.png',
    'CONTACT': '/textures/corridor/doors/beb.png',
    'EXPERIANCE': '/textures/corridor/doors/beb.png',
    'EDUCATION': '/textures/corridor/doors/beb.png',
    'ABOUTE': '/textures/corridor/doors/beb.png',
    'CERTFICATION': '/textures/corridor/doors/beb.png',
    'VIE SOCIALE': '/textures/corridor/doors/beb.png',
};

// Painted (colored) variants for brush-stroke reveal on hover
const DOOR_PAINTED_TEXTURES = {
    'THE GALLERY': '/textures/corridor/doors/beb_mlwen.png',
    'THE STUDIO': '/textures/corridor/doors/beb_mlwen.png',
    'THE ABOUT': '/textures/corridor/doors/beb_mlwen.png',
    "LET'S CONNECT": '/textures/corridor/doors/beb_mlwen.png',
    'LANGUE': '/textures/corridor/doors/beb_mlwen.png',
    'LANGUES': '/textures/corridor/doors/beb_mlwen.png',
    'MES PROJETS': '/textures/corridor/doors/beb_mlwen.png',
    'A PROPOS': '/textures/corridor/doors/beb_mlwen.png',
    'À PROPOS': '/textures/corridor/doors/beb_mlwen.png',
    'ENGAGEMENT ASSOCIATIF': '/textures/corridor/doors/beb_mlwen.png',
    'ENGAGEMENTS ASSOCIATIFS': '/textures/corridor/doors/beb_mlwen.png',
    'CERTIFICATION': '/textures/corridor/doors/beb_mlwen.png',
    'CERTIFICATIONS': '/textures/corridor/doors/beb_mlwen.png',
    'CONTACT': '/textures/corridor/doors/beb_mlwen.png',
    'EXPERIANCE': '/textures/corridor/doors/beb_mlwen.png',
    'EDUCATION': '/textures/corridor/doors/beb_mlwen.png',
    'ABOUTE': '/textures/corridor/doors/beb_mlwen.png',
    'CERTFICATION': '/textures/corridor/doors/beb_mlwen.png',
    'VIE SOCIALE': '/textures/corridor/doors/beb_mlwen.png',
};
...
const DoorSection = ({
    ...
    const doorId = useMemo(() => {
        ...
        if (label === 'THE GALLERY' || label === 'MES PROJETS' || label === 'EDUCATION') return 'gallery';
        if (label === 'THE STUDIO') return 'studio';
        if (label === 'THE ABOUT' || label === 'A PROPOS' || label === 'À PROPOS' || label === 'ABOUTE') return 'about';
        if (label === "LET'S CONNECT" || label === 'CONTACT') return 'contact';
        if (label === 'LANGUE' || label === 'LANGUES' || label === 'EXPERIANCE') return 'experience';
        if (label === 'ENGAGEMENT ASSOCIATIF' || label === 'ENGAGEMENTS ASSOCIATIFS' || label === 'CERTFICATION') return 'certification';
        if (label === 'CERTIFICATION' || label === 'CERTIFICATIONS' || label === 'VIE SOCIALE') return 'social';
        return null;
    }, [label, roomId]);
    ...
    const signTextureUrl = '/textures/corridor/sur.png';
                ...
                <group position={[wallOffsetX, -0.4, 0]}>
                    ...
                    <group position={[0, doorHeight / 2 + 0.45, 0.08]}>
                        ...
                        */}
                        ...
                        {/* === DYNAMIC TEXT FOR SIGNS — always shows the door label === */}
                        <Text
                            font="/fonts/CabinSketch-Bold.ttf"
                            fontSize={label && label.length > 15 ? 0.16 : 0.22}
                            color="#111111"
                            anchorX="center"
                            anchorY="middle"
                            position={[0, 0, 0.01]}
