...
const RUBIK_SCRIBBLE_URL = '/fonts/rubik-ecriture-regular.ttf';
 ...
 * - ACHREF in Rubik Scribble font (splits into letters during scroll)
...
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for ACHREF split effect
    const letters = useMemo(() => [
        { char: 'A', baseX: -1.55, splitDir: -2.4, delay: 0 },
        { char: 'C', baseX: -0.95, splitDir: -1.6, delay: 0 },
        { char: 'H', baseX: -0.35, splitDir: -0.6, delay: 0 },
        { char: 'R', baseX: 0.25, splitDir: 0.6, delay: 0 },
        { char: 'E', baseX: 0.85, splitDir: 1.6, delay: 0 },
        { char: 'F', baseX: 1.45, splitDir: 2.4, delay: 0 },
    ], []);

    // Tagline message for split effect
    const taglineWords = useMemo(() => [
        { text: '</', baseX: -1, splitDir: -1.5, delay: 0 },
        { text: 'Turning Ideas ', baseX: -0.5, splitDir: -0.8, delay: 0 },
        { text: 'Into Reality', baseX: 0.4, splitDir: 0.8, delay: 0 },
    ...
    useFrame((state, delta) => {
        ...
        // Apply split to each letter of ACHREF
    ...
    return (
        <group ref={groupRef} position={position} scale={[scale, scale, 1]}>
            {/* ACHREF Letters - Rubik Scribble font with fade-in animation */}
            ...
            {/* Tagline text - Cabin Sketch font with fade-in animation */}
