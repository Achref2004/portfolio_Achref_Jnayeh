 ...
 * Each segment contains: walls, avatar, ACHREF text, doors, decorations.
 * 
...
const CorridorSegment = ({
    ...
    const doors = useMemo(() => {
        const doorDefs = [
            ...
            {
                id: `certification-${segmentIndex}`,
                roomId: 'certification',
                relativeZ: -62,
                side: 'left',
    ...
    return (
        <group position={[0, 0, 0]}>
            ...
            <group position={[0, 0, zOffset - 2]}>
                {/* ACHREF Text - centered (ACHREF letters adjusted internally) */}
