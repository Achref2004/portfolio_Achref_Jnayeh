...
const SegmentDoors = ({
    ...
    const doorLeftTexture = useTexture('/textures/corridor/doors/doorrleft.png');
    const doorRightTexture = useTexture('/textures/corridor/doors/dorright.png');
    ...
    const doorBackTexture = useTexture('/textures/corridor/doors/door_back.png');
    ...
    const coffeeTexture = useTexture('/textures/corridor/aj.png');
    const ideaTexture = useTexture('/textures/corridor/decorations/idea_process.png');
